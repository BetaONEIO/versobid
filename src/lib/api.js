...
function uploadImage(file, path) {
    return __awaiter(this, void 0, void 0, function () {
        var uploadError, publicUrl, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase_1.supabase
                            ...
                            .or("participant1_id.eq.".concat(userId, ",participant2_id.eq.").concat(userId))
                ...
                case 2:
                    error_4 = _b.sent();
                    console.error('Error fetching chats:', error_4);
                    throw error_4;
                case 3: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_5 = _a.sent();
                    console.error('Error marking messages as read:', error_5);
                    throw error_5;
                case 3: return [2 /*return*/];
            }
        });
