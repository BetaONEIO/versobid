...
exports.default = BiddingHistory;
...
function BiddingHistory() {
    var _this = this;
    var _a = (0, react_1.useState)([]), bids = _a[0], setBids = _a[1];
    ...
    var fetchBids = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    error_1 = _b.sent();
                    console.error('Error fetching bids:', error_1);
                    react_hot_toast_1.default.error('Failed to load bidding history');
                    return [3 /*break*/, 5];
                case 4:
                    setLoading(false);
                    return [7 /*endfinally*/];
    ...
    return (<div className="space-y-6">
      {bids.map(function (bid) {
            var _a;
            return (<div key={bid.id} className="bg-white dark:bg-gray-700 rounded-lg shadow overflow-hidden cursor-pointer hover:shadow-md transition-shadow" onClick={function () { return navigate("/item/".concat(bid.item_id)); }}>
          <div className="p-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                {(_a = bid.item) === null || _a === void 0 ? void 0 : _a.title}
              </h3>
