...
export const DeliveryPreferences: React.FC<DeliveryPreferencesProps> = ({ options, onChange }) => {
  ...
  const updateShippingDetails = (cost?: number, postcode?: string, town?: string) => {
          ...
          {shippingOption && (
            <div className="ml-6 space-y-3">
              ...
              <PostcodeLookup
                ...
                onChange={(postcode) => updateShippingDetails(undefined, postcode)}
                onValidated={() => {}}
            ...
            <div className="ml-6 space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  min="1"
                  max="100"
                  value={pickupOption.location?.maxDistance || ''}
